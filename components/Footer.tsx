  ...
  return (
    <footer className="w-full pt-20 pb-10" id="contact">
      <div className="flex flex-col items-center">
        <h1 className="text-2xl lg:text-5xl text-center font-bold lg:max-w-[45vw]">
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
        <p className="md:text-base text-sm md:font-medium font-normal">
          Copyright © 2025 Mohammed Arfat
        </p>
